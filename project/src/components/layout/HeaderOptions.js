...
import { logout, getAuthData } from "../../api/services/auth.service";
import {
  isUserDataErrored,
  isUserDataLoading,
} from "../../redux/selectors/userData/userDataSelector";
import {
  setUserDataStartAC,
...
const mapStateToProps = (state) => {
  return {
    error: isUserDataErrored(state),
    loading: isUserDataLoading(state),
